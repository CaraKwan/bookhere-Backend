...
public class StayAvailability implements Serializable {
    ...
    @EmbeddedId
    private StayAvailabilityKey id;   //Composite key : stay id + date

    @MapsId("stay_id")    //Like @JoinColumn, because stay id is defined inside composite key
    @ManyToOne
    private Stay stay;   //Foreign key
