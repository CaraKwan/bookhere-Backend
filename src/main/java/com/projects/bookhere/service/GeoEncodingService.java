...
import com.projects.bookhere.exception.GeoEncodingException;
import com.projects.bookhere.exception.InvalidStayAddressException;
...
/* Convert the address of a stay to latitude and longitude wrapped in Location class */
@Service
public class GeoEncodingService {
    @Value("${geocoding.apikey}")   //Map to geocoding.apikey in application.properties
